        ...
        <div class="flex flex-wrap md:text-left text-center order-first">
          <div class="lg:w-1/3 md:w-1/2 w-full px-4">
            ...
            <nav class="list-none mb-10">
              <li>
                <a class="text-white hover:text-gray-300">About Us</a>
              </li>
              <li>
                <a class="text-white hover:text-gray-300">Blog</a>
              </li>
              <li>
                <a class="text-white hover:text-gray-300">Contact</a>
              </li>
            </nav>
          </div>
          ...
          <div class="lg:w-1/3 md:w-1/2 w-full px-4">
            <h1 class="title-font font-medium text-white tracking-widest text-sm mb-3">
              SUBSCRIB to out newsletter to get notified about new events and
              insightful blogs
            </h1>
            <div class="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
              <div class="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
                ...
                <input
                  ...
                  id="footer-field"
                  name="footer-field"
                  class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 focus:border-gray-500 text-base outline-none text-gray-200 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                />
              </div>
